...
\[H(X)_{Rényi} = -\frac{1}{1-\alpha}\log_{2}\!\left( \sum_{n \in X} p_{n}^{\alpha}  \right),\]

con \(p_{n}\) ponderado al doble para caracteres no alfabéticos y $\alpha = 2$ el peso elegido.
...
Y como último, en el caso de los tiempos de respuesta, se observa que las funciones más simples como Aleatory Generation y Discriminatory presentaron valores muy bajos en C++, con medias cercanas a 
$1.20 \times 10^{-6}$ y $4.54 \times 10^{-6}$ segundos, mientras que las funciones Hybrid y Greedy destacaron por ser más costosas, con tiempos de hasta $1.26$ segundos y $4.85 \times 10^{-3}$ segundos. A comparación, en R los tiempos fueron considerablemente mayores: la función híbrida alcanzó valores de $0.125$ y $3.41$ en distintas ejecuciones, mientras que Greedy se mantuvo en torno a $0.045$ y $0.0048$. Las funciones Weighted y Aleatory Iteration mostraron tiempos más bajos, entre $2.35 \times 10^{-5}$ y $1.10 \times 10^{-6}$ segundos, aunque con cierta variabilidad en las repeticiones. La desviación estándar, por su parte, reflejó una mayor dispersión en los métodos híbridos de R, con valores que oscilaron entre $0.125$ y $3.41$ segundos, mientras que en los algoritmos Greedy y Aleatory los tiempos fueron más estables y controlados, manteniéndose en rangos mucho más pequeños.
...
Cabe recalcar, que a pesar de que los tiempos son exageradamente mejores en C++, siendo hasta 100 veces más rapidos en algunos algoritmos; a la hora de manipular y escribir codigo este lenguaje presento muchas mayores complicaciones debido a ser un lenguaje de bajo nivel. 
